...
def sentencize_cli():
    ...
    parser.add_argument('--max_tokens', type=int, default=100, help="each chunk is at most this many tokens, except if necessary for min_sent/min_tokens (only with --context or --chunks).")
    args = parser.parse_args()
